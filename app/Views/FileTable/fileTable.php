 ...
 *
 * @param $urlMethode Est l'identifiant du controleur et de la méthode utilisée. Apres le base_url et avant les paramêtres. Par defaut: FileTable/getView
...
<?php
  if (!empty($files)) { 
    ...
    foreach ($files as $key => $value) {
      ...
      if (!$value->is_dir()) {
        echo '<a href=' . base_url('FileController/getView') . $slashOrNot . $encode_path . '>';
        echo $avatar;
  ...
  <div class="aucunResultatContainer">
      <span class="aucunResultat">Aucun résultat trouvé :(</span>
  </div>
